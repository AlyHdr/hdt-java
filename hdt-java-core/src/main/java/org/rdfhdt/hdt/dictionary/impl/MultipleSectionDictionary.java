...
MultipleSectionDictionary extends MultipleBaseDictionary {
    ...
    public MultipleSectionDictionary(HDTOptions spec) {
        ...
        objects = new HashMap<String, DictionarySectionPrivate>();
    ...
    public void load(TempDictionary other, ProgressListener listener) {
        ...
        Iterator hmIterator = other.getAllObjects().entrySet().iterator();
        ...
        while (hmIterator.hasNext()){
            ...
            section.load(subSection,iListener);
            objects.put((String)entry.getKey(),section);
        }
